...
# DR-05 patch
chpst -u root:root chmod 750 /var/vcap/store/redis

# DR-06 patch
chpst -u root:root chown vcap:vcap /var/vcap/jobs/redis/config/redis.conf
chpst -u root:root chmod 600 /var/vcap/jobs/redis/config/redis.conf
